...
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/load_use
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/jump_use
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/fetch_instruction
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/dec_instruction
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/exec_instruction
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/mem_instruction
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/flag_lu
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/flag_ju
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/flag_lu_done
add wave -noupdate /system_tb/DUT/CPU/DP0/huif/flag_ju_done
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/halt
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/ihit
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/imemREN
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/imemload
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/imemaddr
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/dhit
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/datomic
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/dmemREN
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/dmemWEN
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/flushed
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/dmemload
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/dmemstore
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/dcif1/dmemaddr
add wave -noupdate -group {Datapath 1} /system_tb/DUT/CPU/CM1/DCACHE/state
add wave -noupdate /system_tb/DUT/CPU/CC/state
add wave -noupdate /system_tb/DUT/CPU/CC/prio
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/dwait
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/dREN
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/dWEN
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/dload
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/dstore
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/daddr
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/ccwait
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/ccinv
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/ccwrite
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/cctrans
add wave -noupdate -group Bus /system_tb/DUT/CPU/CC/ccif/ccsnoopaddr
...
WaveRestoreCursors {{Cursor 1} {2423106 ps} 0}
...
update
WaveRestoreZoom {1972 ns} {3278 ns}
